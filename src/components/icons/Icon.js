...
function Icon(props) {
	...
	if ("reply" in props) {
		button = (
			<div onClick={props.setReply} className="icon icon--reply">
		...
		button = (
			<div onClick={props.onClick} className="icon icon--delete">
	...
	} else if ("edit" in props) {
		button = (
			<div onClick={props.setEdit} className="icon icon--edit">
